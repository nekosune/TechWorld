...
public class TechTeleporter extends Teleporter {
    ...
    public TechTeleporter(WorldServer par1WorldServer) {
                ...
                for (i3 = 1; i3 < 3; ++i3) {
                    for (l2 = -1; l2 < 3; ++l2) {
                        ...
                        worldServerInstance.setBlock(k3, j3, i4,
                                flag ? Block.blockRedstone.blockID : 0);
                    }
                }
            }
        }
        for (k2 = 0; k2 < 4; ++k2) {
            for (i3 = 0; i3 < 4; ++i3) {
                for (l2 = -1; l2 < 4; ++l2) {
                    ...
                    /** change these blocks **/
                    worldServerInstance.setBlock(k3, j3, i4,
                            flag ? Block.blockRedstone.blockID
                                    : TechWorld.TechPortal.blockID, 0, 2);
                }
            }
            for (i3 = 0; i3 < 4; ++i3) {
                for (l2 = -1; l2 < 4; ++l2) {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2,
            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        /** change this block **/
                        if (worldServerInstance.getBlockId(k1, i2, l1) == TechWorld.TechPortal.blockID) {
                            /** change this block **/
                            while (worldServerInstance.getBlockId(k1, i2 - 1,
                                    l1) == TechWorld.TechPortal.blockID) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                destinationCoordinateCache.add(j1, new TechPortalPosition(this,
                        i, j, k, worldServerInstance.getTotalWorldTime()));
            ...
            int j2 = -1;
            /** change this block **/
            if (worldServerInstance.getBlockId(i - 1, j, k) == TechWorld.TechPortal.blockID) {
                j2 = 2;
            }
            /** change this block **/
            if (worldServerInstance.getBlockId(i + 1, j, k) == TechWorld.TechPortal.blockID) {
            ...
            /** change this block **/
            if (worldServerInstance.getBlockId(i, j, k - 1) == TechWorld.TechPortal.blockID) {
                j2 = 3;
            }
            /** change this block **/
            if (worldServerInstance.getBlockId(i, j, k + 1) == TechWorld.TechPortal.blockID) {
